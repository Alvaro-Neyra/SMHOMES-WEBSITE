export function EnterpriseIcon({className}: Readonly<{ className?: string }>) {
    return (
        <svg fill="#D7BF66" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" className={className}>
