import { HeroImageProps } from "@/app/utils/interfaces";
import Image from 'next/image';
import Link from "next/link";

export default function HeroImage({ src, heading, subHeading, linkText, linkHref }: Readonly<HeroImageProps>) {
    return (
        <div className="relative w-full overflow-hidden py-[1.5vw] px-[5vw]">
