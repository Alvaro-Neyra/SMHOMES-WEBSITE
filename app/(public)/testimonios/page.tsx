...
export const metadata: Metadata = {
    ...
    description:
        "Descubre cómo SM HOME'S ha transformado la experiencia inmobiliaria para nuestros clientes. Lee sus testimonios y únete a nosotros.",
    keywords:
        "testimonios clientes, experiencias SM HOME'S, testimonios inmobiliaria Torrevieja, opiniones SM HOME'S, ventas inmobiliarias Torrevieja, agentes inmobiliarios, clientes satisfechos Torrevieja",
    robots: "index, follow",
    openGraph: {
        title: "Testimonios de Clientes - SM HOME'S",
        description:
            "Descubre cómo SM HOME'S ha transformado la experiencia inmobiliaria para nuestros clientes. Lee sus testimonios y únete a nosotros.",
        images: ["/testimonios.png"],
        url: "https://www.smhomesrealstate.com/testimonios",
        type: "website",
    },
    twitter: {
        title: "Testimonios de Clientes - SM HOME'S",
        description:
            "Lee lo que nuestros clientes piensan sobre los servicios inmobiliarios de SM HOME'S en Torrevieja. Transformamos la experiencia inmobiliaria.",
        images: ["/testimonios.png"],
