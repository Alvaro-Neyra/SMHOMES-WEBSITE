...
export default function ServicioHomePage() {
    return (
        <>
            <Head>
                <title>Servicio Home - Vende tu casa rápido con SM HOME&apos;S</title>
                <meta
                    name="description"
                    content="Conoce nuestro servicio HOME y descubre cómo podemos ayudarte a vender tu propiedad rápidamente y al mejor precio. ¡Haz de tu casa una oportunidad irresistible!"
                />
                <meta
                    name="keywords"
                    content="Servicio Home, vender casa rápidamente, servicio inmobiliario, vender propiedad Torrevieja, SM HOME'S, vender casa al mejor precio, servicios inmobiliarios, Torrevieja, inmobiliaria"
                />
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="Servicio Home - Vende tu casa rápido con SM HOME&apos;S" />
                <meta
                    property="og:description"
                    content="Conoce nuestro servicio HOME y descubre cómo podemos ayudarte a vender tu propiedad rápidamente y al mejor precio. ¡Haz de tu casa una oportunidad irresistible!"
                />
                <meta property="og:image" content="/servicio-home.png" />
                <meta property="og:url" content="https://www.smhomesrealstate.com/servicio-home" />
                <meta property="og:type" content="website" />
                <meta name="twitter:title" content="Servicio Home - Vende tu casa rápido con SM HOME&apos;S" />
                <meta
                    name="twitter:description"
                    content="Conoce nuestro servicio HOME y descubre cómo podemos ayudarte a vender tu propiedad rápidamente y al mejor precio. ¡Haz de tu casa una oportunidad irresistible!"
                />
                <meta name="twitter:image" content="/servicio-home.png" />
                <meta name="twitter:url" content="https://www.smhomesrealstate.com/servicio-home" />
