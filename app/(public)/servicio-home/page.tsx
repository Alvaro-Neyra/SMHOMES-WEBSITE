...
export const metadata: Metadata = {
    title: "Servicio Home - Vende tu casa rápido con SM HOME'S",
    description:
        "Conoce nuestro servicio HOME y descubre cómo podemos ayudarte a vender tu propiedad rápidamente y al mejor precio. ¡Haz de tu casa una oportunidad irresistible!",
    keywords:
        "Servicio Home, vender casa rápidamente, servicio inmobiliario, vender propiedad Torrevieja, SM HOME'S, vender casa al mejor precio, servicios inmobiliarios, Torrevieja, inmobiliaria",
    robots: "index, follow",
    openGraph: {
        title: "Servicio Home - Vende tu casa rápido con SM HOME'S",
        description:
            "Conoce nuestro servicio HOME y descubre cómo podemos ayudarte a vender tu propiedad rápidamente y al mejor precio. ¡Haz de tu casa una oportunidad irresistible!",
        images: ["/servicio-home.png"],
        url: "https://www.smhomesrealstate.com/servicio-home",
        type: "website",
    },
    twitter: {
        title: "Servicio Home - Vende tu casa rápido con SM HOME'S",
