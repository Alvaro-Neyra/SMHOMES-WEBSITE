...
export default function SellPage() {
    return (
        <>
            <Head>
                <title>Vender tu Casa en Torrevieja - SM HOME&apos;S</title>
                <meta
                    name="description"
                    content="En SM HOME&apos;S, ofrecemos un servicio completo y rápido para vender tu propiedad en Torrevieja y alrededores. Descubre cómo podemos ayudarte a vender tu casa de forma segura y eficiente."
                />
                <meta
                    name="keywords"
                    content="vender casa Torrevieja, vender propiedad en Alicante, inmobiliaria Torrevieja, vender apartamento rápido, vender casa en tiempo record, inmobiliaria cerca de la playa, SM HOME'S, venta de propiedades, asesoría inmobiliaria Torrevieja"
                />
                <meta name="robots" content="index, follow" />
                <meta property="og:title" content="Vender tu Casa en Torrevieja - SM HOME&apos;S" />
                <meta
                    property="og:description"
                    content="En SM HOME&apos;S, ofrecemos un servicio completo y rápido para vender tu propiedad en Torrevieja y alrededores. Descubre cómo podemos ayudarte a vender tu casa de forma segura y eficiente."
                />
                <meta property="og:image" content="/vender.png" />
                <meta property="og:url" content="https://www.smhomesrealstate.com/vender" />
                <meta property="og:type" content="website" />
                <meta name="twitter:title" content="Vender tu Casa en Torrevieja - SM HOME&apos;S" />
                <meta
                    name="twitter:description"
                    content="Vende tu casa en Torrevieja con SM HOME&apos;S. Servicio rápido, confiable y eficiente para hacer de la venta de tu propiedad una experiencia sin estrés."
                />
                <meta name="twitter:image" content="/vender.png" />
                <meta name="twitter:url" content="https://www.smhomesrealstate.com/vender" />
            ...
            <section>
                ...
                <HeroForm
                    id="sell-reasons-section"
                    heading="En SM HOME&apos;S, eliminamos el estrés del proceso y te ofrecemos el servicio inmobiliario más completo para vender tu propiedad de forma rápida, cómoda y al mejor precio."
                    subHeading="¿Qué hacemos para vender tu casa en tiempo record?"
                    strongSubHeading="vender tu casa en tiempo record"
                    otherChildren={<Faq items={FAQItems} />}
                    sellSection={true}
                >
                    <section>
