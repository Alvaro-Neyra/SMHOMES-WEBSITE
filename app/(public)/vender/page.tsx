...
export const metadata: Metadata = {
    title: "Vender tu Casa en Torrevieja - SM HOME'S",
    description:
        "En SM HOME'S, ofrecemos un servicio completo y rápido para vender tu propiedad en Torrevieja y alrededores. Descubre cómo podemos ayudarte a vender tu casa de forma segura y eficiente.",
    keywords:
        "vender casa Torrevieja, vender propiedad en Alicante, inmobiliaria Torrevieja, vender apartamento rápido, vender casa en tiempo record, inmobiliaria cerca de la playa, SM HOME'S, venta de propiedades, asesoría inmobiliaria Torrevieja",
    robots: "index, follow",
    openGraph: {
        title: "Vender tu Casa en Torrevieja - SM HOME'S",
        description:
            "En SM HOME'S, ofrecemos un servicio completo y rápido para vender tu propiedad en Torrevieja y alrededores. Descubre cómo podemos ayudarte a vender tu casa de forma segura y eficiente.",
        images: ["/vender.png"],
        url: "https://www.smhomesrealstate.com/vender",
        type: "website",
    },
    twitter: {
        title: "Vender tu Casa en Torrevieja - SM HOME'S",
        description:
            "Vende tu casa en Torrevieja con SM HOME'S. Servicio rápido, confiable y eficiente para hacer de la venta de tu propiedad una experiencia sin estrés.",
        images: ["/vender.png"],
